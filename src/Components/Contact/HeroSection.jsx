...
export default function HeroSection() {
    ...
    return (
        ...
        <div className="relative max-sm:flex max-sm:justify-center max-sm:items-center">
            ...
            <div className="bg-slate-900 w-[70%] py-[1%] rounded-md absolute left-[16%] top-[90%] flex justify-center items-center  4xl:top-[90%] 3xl:top-[90%] sm:max-xl:w-[100%] sm:max-xl:left-[0%] sm:max-xl:rounded-none sm:max-xl:py-[4%] max-sm:w-[100%] max-sm:left-[0%] max-sm:justify-start max-sm:rounded-none">
