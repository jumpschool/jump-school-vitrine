...
export default function PrivacyPolicy({ isChecked1, setChecked1 }) {
    ...
    return (
        <>
            <section>
                <div>
                    <p className="mt-4 text-black text-sm mb-5 max-sm:text-justify">
                ...
                <div className="checkbox_policy">
                    <p className="text-sm text-black mb-4 max-sm:text-justify">Vous pouvez vous désabonner de ces communications à tout moment.</p>
                    <p className="text-sm mb-4 text-black max-sm:text-justify" id="ImportantCheck">En cliquant sur « Envoyer » ci-dessous, vous autorisez l’entreprise O'clock à stocker et traiter les données personnelles soumises ci-dessus afin qu’elle vous fournisse le contenu demandé.</p>
                    <p className="font-medium text-sm text-black">* les champs obligatoires</p>
                </div>
            </section>
        </>
    );
