...
export default function Rapport(){
    return(
        <>
        <section className='bg-rose-200 flex justify-center items-center w-full h-[55vh] max-sm:flex-col sm:max-xl:h-full sm:max-xl:py-[5%] '>
            ...
            <div className='w-[60%] flex items-start gap-5 flex-col  max-sm:w-[100%] max-sm:px-[3%] '>
                ...
                <button className="hover:bg-rose-200  hover:border-2 hover:border-rose-600 hover:text-rose-600  hover:rounded-md Text-navbar-element bg-rose-600 text-lg px-[2%] text-white font-bold rounded-lg ">
