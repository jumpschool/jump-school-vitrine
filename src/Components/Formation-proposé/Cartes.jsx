...
function Cartes() {
  return ( 
    <div className="section-container column_holder mt-16 w-full mx-auto bg-green-300 ">
      
      {/* First Container for the first 3 cards */}
      <div className="grid grid-cols-1 bg-blue-500 md:grid-cols-2 lg:grid-cols-3 gap-12 w-3/4 max-sm:w-9/10 lg-custom-width mx-auto">
 ...
 <div className="relative">
      ...
      <div className="grid grid-cols-1 bg-red-500 md:grid-cols-2 lg:grid-cols-3 gap-12 w-3/4 max-sm:w-9/10 lg-custom-width mx-auto max-2xl:flex justify-center items-center">
